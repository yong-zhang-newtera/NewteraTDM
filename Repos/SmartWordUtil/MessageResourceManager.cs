...
namespace Newtera.SmartWordUtil
{
	...
	/// <summary> 
	/// A utility class that cache the resources for messages for SmartWordUtil.
	/// </summary>
	/// <version> 1.0.0 05 May 2012 </version>
	public sealed class MessageResourceManager
	{
		...
		private static ResourceManager GetResources() 
		{
			...
			if (resources == null)
			{
				...
				try
				{
					resources = new ResourceManager("Newtera.SmartWordUtil.MessageResourceManager",
                        typeof(Newtera.SmartWordUtil.MessageResourceManager).Assembly);
