...
namespace Newtera.Server.Attachment
{
	...
	/// <summary>
	/// Represents a file system implementation of IAttachmentRepository interface
	/// where attachment files are stored as files of the OS file system.
	/// </summary>
	/// <version> 1.0.1	10 Jan 2004 </version>
	/// <author>Yong Zhang </author>
	public class AttachmentFileRepository : AttachmentRepositoryBase
	{
		/// <summary>
		/// Instantiate an instance of AttachmentFileRepository class.
		/// </summary>
		public AttachmentFileRepository() : base()
		{
		}
