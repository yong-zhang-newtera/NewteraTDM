/*
* @(#) AttachmentSQLServerCERepository.cs
*
...
namespace Newtera.Server.Attachment
{
	...
	public class AttachmentSQLServerCERepository : AttachmentRepositoryBase
	{
		/// <summary>
		/// Instantiate an instance of AttachmentSQLServerCERepository class.
		/// </summary>
		public AttachmentSQLServerCERepository() : base()
		{
		}
