...
namespace Newtera.Server.Attachment
{
	...
	/// </summary>
	public class AttachmentMySqlRepository : AttachmentRepositoryBase
	{
		/// <summary>
		/// Instantiate an instance of AttachmentMySqlRepository class.
		/// </summary>
		public AttachmentMySqlRepository() : base()
		{
		}
