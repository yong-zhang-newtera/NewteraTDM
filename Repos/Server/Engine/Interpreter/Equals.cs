...
namespace Newtera.Server.Engine.Interpreter
{
	...
	public class Equals : BinaryExpr
	{
		/// <summary>
		/// Initiate an instance of Equals object.
		/// </summary>
		public Equals(Interpreter interpreter, IExpr left, IExpr right) : base(interpreter, left, right)
		{
		}
