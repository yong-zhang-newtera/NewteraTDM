...
namespace Newtera.Server.Engine.Interpreter
{
	...
	public class UMinus : Unary
	{
		/// <summary>
		/// Initiate an instance of UMinus object.
		/// </summary>
		/// <param name="term">the unary operand</param> 
		public UMinus(Interpreter interpreter, IExpr term) : base(interpreter, term)
		{
		}
