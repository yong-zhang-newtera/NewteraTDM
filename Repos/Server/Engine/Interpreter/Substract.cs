...
namespace Newtera.Server.Engine.Interpreter
{
	...
	/// <summary>
	/// Represents a Substract expression
	/// </summary>
	/// <version> 1.0.0 14 Aug 2003 </version>
	/// <author> Yong Zhang</author>
	public class Substract : BinaryExpr
	{
		/// <summary>
		/// Initiate an instance of Substract object.
		/// </summary>
		public Substract(Interpreter interpreter, IExpr left, IExpr right) : base(interpreter, left, right)
		{
		}
		...
		/// <summary>
		/// Perform the substract operation
		/// </summary>
