...
namespace Newtera.Server.Engine.Interpreter
{
	...
	public class XFloat : Value
	{
		private float _content;

		/// <summary>
		/// Initiate an instance of XFloat object.
		/// </summary>
		/// <param name="content">The content of XFloat object</param>
		public XFloat(float content) : base(new FloatType())
		{
			_content = content;
		}
		...
		/// </summary>
		/// <param name="content">The content of XFloat object</param>
		public XFloat(string content) : base(new FloatType())
		{
			_content = System.Convert.ToSingle(content);
		}
		...
		{
			System.Console.WriteLine("Float Value : " + ToString());
		}
	}
}