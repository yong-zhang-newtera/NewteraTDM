...
namespace Newtera.Server.Engine.Interpreter
{
	...
	/// <summary>
	/// Represents a NotEquals expression
	/// </summary>
	/// <version> 1.0.0 14 Aug 2003 </version>
	/// <author> Yong Zhang</author>
	public class NotEquals : BinaryExpr
	{
		/// <summary>
		/// Initiate an instance of NotEquals object.
		/// </summary>
		public NotEquals(Interpreter interpreter, IExpr left, IExpr right) : base(interpreter, left, right)
		{
		}
