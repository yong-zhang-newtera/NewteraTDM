...
namespace Newtera.Server.Engine.Interpreter
{
	...
	public class Like : BinaryExpr
	{
		/// <summary>
		/// Initiate an instance of Like object.
		/// </summary>
		public Like(Interpreter interpreter, IExpr left, IExpr right) : base(interpreter, left, right)
		{
		}
		...
		protected override Value DoOp(IExpr left, IExpr right)
		{
			...
			return dataType.Like(lval,  rval);
		}
