...
namespace Newtera.Server.Engine.Interpreter
{
	...
	public class Or : BinaryExpr
	{
		/// <summary>
		/// Initiate an instance of Or object.
		/// </summary>
		public Or(Interpreter interpreter, IExpr left, IExpr right) : base(interpreter, left, right)
		{
		}
