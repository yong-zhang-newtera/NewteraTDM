...
namespace Newtera.Server.Engine.Interpreter.Builtin
{
	...
	/// <summary> 
	/// verify wether the 
	/// first given string starts with the second given string. Using a 
	/// XBoolean to indicate the result.
	/// </summary>
	/// <version>  1.0 24 Aug 2003</version>
	/// <author>  Yong Zhang</author>
	public class StartsWithFunction : FunctionImpBase
	{
		/// <summary>
		...
		/// </summary>
		public StartsWithFunction() : base()
		{
		}
		...
		public override void CheckArgs(ExprCollection arguments)
		{
			...
			{
				throw new InterpreterException("StartsWithFunction expectes two argument, but got " + _arguments.Count);
			}			
		}
