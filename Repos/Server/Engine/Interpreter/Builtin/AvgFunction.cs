...
namespace Newtera.Server.Engine.Interpreter.Builtin
{
	...
	/// <summary> 
	/// Class AvgFunction is a builtin function to caculate the average of the given 
	/// sequence's values.
	/// </summary>
	/// <version>  1.0 24 Aug 2003</version>
	/// <author>  Yong Zhang </author>
	public class AvgFunction : FunctionImpBase
	{
		/// <summary>
		...
		public override void CheckArgs(ExprCollection arguments)
		{
			...
			{
				throw new InterpreterException("AvgFunction expectes one argument, but got " + _arguments.Count);
			}			
		}
		...
		public override Value Eval()
		{
			...
			return new XFloat(result/values.Count);
		}
	}
}