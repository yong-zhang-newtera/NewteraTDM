...
namespace Newtera.Server.Engine.Interpreter.Builtin
{
	...
	/// 
	/// <summary>
	/// Produce a decimal value by parsing and interpreting a string.
	/// </summary>
	/// <version>  1.0 24 Aug 2003</version>
	/// <author>  Yong Zhang</author>
	public class DecimalFunction : FunctionImpBase
	{
		/// <summary>
		...
		public override void CheckArgs(ExprCollection arguments)
		{
			...
			{
				throw new InterpreterException("DecimalFunction expectes one argument, but got " + _arguments.Count);
			}			
		}
		...
		public override Value Eval()
		{
			...
			result = ((IExpr) _arguments[0]).Eval().ToDecimal();

			return new XDecimal(result);
		}
	}
}