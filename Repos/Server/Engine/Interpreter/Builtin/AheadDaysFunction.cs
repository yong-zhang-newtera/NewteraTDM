...
namespace Newtera.Server.Engine.Interpreter.Builtin
{
	...
	public class AheadDaysFunction : FunctionImpBase
	{
		/// <summary>
		...
		public override void CheckArgs(ExprCollection arguments)
		{
			...
			{
				throw new InterpreterException("AheadDaysFunction expectes one argument, but got " + _arguments.Count);
			}			
		}
