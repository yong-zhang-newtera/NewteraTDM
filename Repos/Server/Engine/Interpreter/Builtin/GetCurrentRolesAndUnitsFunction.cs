...
namespace Newtera.Server.Engine.Interpreter.Builtin
{
	...
	/// <summary>
	/// Gets functions and units of the current loggined user.
	/// </summary>
	/// <version>  1.0.0 25 Apr 2018</version>
	public class GetCurrentRolesAndUnitsFunction : FunctionImpBase
	{
		/// <summary>
		...
		/// </summary>
		public GetCurrentRolesAndUnitsFunction() : base()
		{
		}
		...
		public override void CheckArgs(ExprCollection arguments)
		{
			...
			{
				throw new InterpreterException("GetCurrentRolesAndUnitsFunction expectes no argument, but got " + _arguments.Count);
			}			
		}
		...
		public override Value Eval()
		{
            ...
            if (principal != null)
            {
                ...
                if (!string.IsNullOrEmpty(userId))
                {
                    ...
                    string[] units = userManager.GetRoles(userId);
