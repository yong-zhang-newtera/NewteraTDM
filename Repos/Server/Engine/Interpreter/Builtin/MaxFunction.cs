...
namespace Newtera.Server.Engine.Interpreter.Builtin
{
	...
	/// <summary> 
	/// Find the max value of the given sequence's item values.
	/// </summary>
	/// <version>  1.0 24 Aug 2003</version>
	/// <author>  Yong Zhang </author>
	public class MaxFunction : FunctionImpBase
	{
		/// <summary>
		...
		public override void CheckArgs(ExprCollection arguments)
		{
			...
			{
				throw new InterpreterException("MaxFunction expectes one argument, but got " + _arguments.Count);
			}			
		}
