...
namespace Newtera.Server.Engine.Interpreter.Builtin.Db
{
	...
	/// 
	/// <summary>
	/// Update a data instance represented by XmlElement in the spcified VDocument.
	/// </summary>
	/// <version>  1.0 24 Aug 2003</version>
	/// <author>  Yong Zhang </author>
	public class UpdateInstanceFunction : EditFunctionBase
	{
		/// <summary>
