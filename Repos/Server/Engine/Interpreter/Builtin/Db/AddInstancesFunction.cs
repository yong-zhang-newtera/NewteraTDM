...
namespace Newtera.Server.Engine.Interpreter.Builtin.Db
{
	...
	/// 
	/// <summary>
	/// Add a collection of data instance represented by XmlElements to the spcified VDocument.
	/// </summary>
	/// <version>  1.0 24 Aug 2003</version>
	/// <author>  Yong Zhang </author>
	public class AddInstancesFunction : EditFunctionBase
	{
		/// <summary>
