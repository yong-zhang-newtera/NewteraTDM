...
namespace Newtera.Server.Engine.Interpreter.Builtin.Db
{
	...
	/// 
	/// <summary>
	/// Delete a collection of data instance represented by XmlElements from the spcified VDocument.
	/// </summary>
	/// <version>  1.0 24 Aug 2003</version>
	/// <author>  Yong Zhang </author>
	public class DeleteInstancesFunction : EditFunctionBase
	{
		/// <summary>
		...
		/// </summary>
		public DeleteInstancesFunction()
		{
		}
