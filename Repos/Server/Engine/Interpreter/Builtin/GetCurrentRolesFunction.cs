...
namespace Newtera.Server.Engine.Interpreter.Builtin
{
	...
	/// <summary>
	/// Gets function of the current loggined user.
	/// </summary>
	/// <version>  1.0.0 25 Feb 2008</version>
	public class GetCurrentRolesFunction : FunctionImpBase
	{
		/// <summary>
		...
		/// </summary>
		public GetCurrentRolesFunction() : base()
		{
		}
		...
		public override void CheckArgs(ExprCollection arguments)
		{
			...
			{
				throw new InterpreterException("GetCurrentRolesFunction expectes no argument, but got " + _arguments.Count);
			}			
		}
