...
namespace Newtera.Server.Engine.Interpreter.Builtin
{
	...
	public class UpperCaseFunction : FunctionImpBase
	{
		/// <summary>
		...
		public override void CheckArgs(ExprCollection arguments)
		{
			...
			{
				throw new InterpreterException("UpperCaseFunction expectes one argument, but got " + _arguments.Count);
			}			
		}
		...
		public override Value Eval()
		{
			...
			return new XString(result.ToUpper());
		}
	}
}