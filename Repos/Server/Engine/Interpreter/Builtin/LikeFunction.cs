...
namespace Newtera.Server.Engine.Interpreter.Builtin
{
	...
	public class LikeFunction : FunctionImpBase
	{
		/// <summary>
		...
		public override void CheckArgs(ExprCollection arguments)
		{
			...
			{
				throw new InterpreterException("MacroFunction expectes two argument, but got " + _arguments.Count);
			}			
		}
		...
		{
			throw new InterpreterException("Like function has not been implemented for XML documents");
		}
	}
}