...
namespace Newtera.Server.Engine.Interpreter
{
	...
	/// <summary>
	/// Represents a In expression
	/// </summary>
	/// <version> 1.0.0 14 Aug 2003 </version>
	/// <author> Yong Zhang</author>
	public class In : BinaryExpr
	{
		/// <summary>
		/// Initiate an instance of In object.
		/// </summary>
		public In(Interpreter interpreter, IExpr left, IExpr right) : base(interpreter, left, right)
		{
		}
