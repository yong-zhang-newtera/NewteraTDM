...
namespace Newtera.Server.Engine.Sqlbuilder.Sql
{
	...
	/// <summary>
	/// A SQLServerCESymbolLookup subclass supplies special SQL Server Compact specific symbols.
	/// </summary>
	/// <version>  	1.0.1 12 Apr 2016 </version>
	public class SQLServerCESymbolLookup : SymbolLookup
	{
		/// <summary>
		...
		{
			return "CONVERT(nvarchar, " + dateCol + ", 121)"; // find format for date str
		}
		...
		{
			return "CONVERT(nvarchar, " + timestampCol + ", 121)";
		}
