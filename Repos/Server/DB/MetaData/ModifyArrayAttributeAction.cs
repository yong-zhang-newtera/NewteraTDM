...
namespace Newtera.Server.DB.MetaData
{
	...
	/// <summary>
	/// Modify an array attribute to the database.
	/// </summary>
	/// <version> 1.0.0 17 Oct 2003 </version>
	/// <author> Yong Zhang</author>
	public class ModifyArrayAttributeAction : MetaDataActionBase
	{
		private ModifyFlag _flag;

		/// <summary>
		/// Instantiate an instance of ModifyArrayAttributeAction
		/// </summary>
		/// <param name="metaDataModel">The meta data model of the action</param>
		public ModifyArrayAttributeAction(MetaDataModel metaDataModel,
		...
		public override MetaDataActionType ActionType
		{
			get
			{
				return MetaDataActionType.ModifyArrayAttribute;
			}
		}
