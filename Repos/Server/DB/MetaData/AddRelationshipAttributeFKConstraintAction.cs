/*
* @(#)AddRelationshipAttributeFKConstraintAction.cs
*
...
namespace Newtera.Server.DB.MetaData
{
	...
	/// <summary>
	/// Add the foreign key constraint to a relationship attribute.
	/// </summary>
	/// <version> 1.0.0 17 Oct 2003 </version>
	/// <author> Yong Zhang</author>
	public class AddRelationshipAttributeFKConstraintAction : MetaDataActionBase
	{
		/// <summary>
		/// Instantiate an instance of AddRelationshipAttributeFKConstraintAction
		/// </summary>
		/// <param name="metaDataModel">The meta data model of the action</param>
		public AddRelationshipAttributeFKConstraintAction(MetaDataModel metaDataModel,
		...
		public override MetaDataActionType ActionType
		{
			get
			{
				return MetaDataActionType.AddRelationshipAttributeFKConstraint;
			}
		}

		/// <summary>
		/// Prepare the action for adding FK constraint to a relationship attribute.
		/// </summary>
		...
		/// <summary>
		/// Peform the action of adding FK constraint to a relationship attribute.
		/// </summary>
		...
		public override void Do(IDbConnection con)
		{
			...
			string ddl = generator.GetAddFKConstraintDDL(constraintName,
				relationship.OwnerClass.TableName, relationship.LinkedClass.TableName,
				relationship.ColumnName, relationship.BackwardRelationship.Ownership);
