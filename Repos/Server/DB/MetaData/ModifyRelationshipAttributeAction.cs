/*
* @(#)ModifyRelationshipAttributeAction.cs
*
...
namespace Newtera.Server.DB.MetaData
{
	...
	/// <summary>
	/// Modify a relationship attribute to the database.
	/// </summary>
	/// <version> 1.0.0 17 Oct 2003 </version>
	/// <author> Yong Zhang</author>
	public class ModifyRelationshipAttributeAction : MetaDataActionBase
	{
		private ModifyFlag _flag;

		/// <summary>
		/// Instantiate an instance of ModifyRelationshipAttributeAction
		/// </summary>
		/// <param name="metaDataModel">The meta data model of the action</param>
		public ModifyRelationshipAttributeAction(MetaDataModel metaDataModel,
		...
		public override MetaDataActionType ActionType
		{
			get
			{
				return MetaDataActionType.ModifyRelationshipAttribute;
			}
		}

		/// <summary>
		/// Prepare the action for modifying a relationship attribute
		/// </summary>
		...
		/// <summary>
		/// Peform the action of modifying a foreign key column to a table
		/// </summary>
		...
		public override void Do(IDbConnection con)
		{
			...
			builder.Append(generator.GetAddFKColumnDDL(attribute, _flag));
