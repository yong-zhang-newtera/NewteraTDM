...
namespace Newtera.Server.DB.MetaData
{
	...
	public class SQLServerDDLGenerator : IDDLGenerator
	{
		/// <summary>
		/// Instantiate an instance of SQLServerDDLGenerator class.
		/// </summary>
		...
		public string GetCreateTablespaceDDL(string tableSpaceName, string dataFileDir)
		{
			...
			{
				dataFile = dataFile + @"\" + tableSpaceName.ToUpper() + ".mdf";
			}
			else
			{
				dataFile = dataFile + tableSpaceName.ToUpper() + ".mdf";
			...
			builder.Append("GO ");
			builder.Append("CREATE DATABASE ").Append(tableSpaceName.ToUpper()).Append(" ");
			builder.Append("ON ");
			builder.Append(" NAME = ").Append(tableSpaceName.ToUpper()).Append("_dat, ");
			builder.Append("FILENAME = '").Append(dataFile).Append("', ");
			builder.Append("SIZE = 50, ");
			builder.Append("MAXSIZE = UNLIMITED, ");
			builder.Append("FILEGROWTH = 10 ) ");
			builder.Append("GO");
