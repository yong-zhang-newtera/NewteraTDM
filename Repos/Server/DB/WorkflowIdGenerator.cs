...
namespace Newtera.Server.DB
{
	...
	public class WorkflowIdGenerator : KeyGenerator
	{
		/// <summary>
		/// Initiating an instance of WorkflowIdGenerator class.
		/// </summary>
		/// <param name="dataProvider">The data provider for the schema</param>
		public WorkflowIdGenerator(IDataProvider dataProvider) : base(dataProvider)
		{
		}
