	...
	public sealed class MessageResourceManager
	{
		...
		private static ResourceManager GetResources() 
		{
			...
			if (resources == null)
			{
				...
				try
				{
                    resources = new ResourceManager("Newtera.WorkflowStudioControl.MessageResourceManager",
                        typeof(Newtera.WorkflowStudioControl.MessageResourceManager).Assembly);
