/*
* @(#)ImportExportResourceManager.cs
*
...
namespace Newtera.Studio.ImportExport
{
	...
	/// <summary> 
	/// A utility class that cache the resources for different cultures
	/// </summary>
	/// <version> 1.0.0 05 Sep 2004 </version>
	/// <author> Yong Zhang </author>
	public sealed class ImportExportResourceManager
	{
		...
		/// </summary>
		private ImportExportResourceManager()
		{
		}
		...
		private static ResourceManager GetResources() 
		{
			...
			if (resources == null)
			{
				...
				try
				{
					resources = new ResourceManager("Newtera.Studio.ImportExport.ImportExportResourceManager",
						typeof(Newtera.Studio.ImportExport.ImportExportResourceManager).Assembly);
