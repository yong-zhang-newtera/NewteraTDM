...
namespace Newtera.Studio
{
	...
	/// <summary>
    /// Conversion between a IDataViewElement object representing an action function
	/// expression and string
	/// </summary>
	/// <version>  1.0.0 16 Oct 2007</version>
    public class RuleActionConverter : ExpandableObjectConverter
	{
		/// <summary> 
			...
			CultureInfo culture, object value, Type destinationType)
		{
			...
			if (value != null && value is IDataViewElement)
			{
                ...
                converted = ((IDataViewElement)value).Name;
