/*
* @(#)EventConditionPropertyConverter.cs
*
...
namespace Newtera.Studio
{
	...
	/// <summary>
	/// Conversion between a IDataViewElement object representing a condition and string
	/// </summary>
	/// <version>  1.0.1 22 Dec 2006</version>
	public class EventConditionPropertyConverter : TypeConverter
	{
		/// <summary> 
