...
namespace Newtera.Studio.UserControls
{
	...
	public class ChooseReferencedClassDialog : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.showLeafClassButton.Click += new System.EventHandler(this.showLeafClassButton_Click);
            // 
            // ChooseReferencedClassDialog
            // 
            resources.ApplyResources(this, "$this");
            this.Controls.Add(this.showLeafClassButton);
        ...
        private void showLeafClassButton_Click(object sender, EventArgs e)
        {
            if (this.linkedClassesListView.SelectedItems.Count == 1)
            {
                LinkedClassListViewItem listViewItem = (LinkedClassListViewItem)this.linkedClassesListView.SelectedItems[0];
                ...
                ChooseLeafClassDialog dialog = new ChooseLeafClassDialog();
                dialog.ParentClass = listViewItem.LinkedClassElement;
                if (dialog.ShowDialog() == DialogResult.OK)
                {
                    string leafClassName = dialog.SelectedLeafClassName;
                    string leafClassCaption = dialog.SelectedLeafClassCaption;
                    ...
                    if (!isAdded)
                    {
                        ...
                        // Add the linked class as a referenced class to data view
                        DataClass referencedClass = new DataClass(relationship.LinkedClassAlias,
                            leafClassName, DataClassType.ReferencedClass);
                        referencedClass.ReferringClassAlias = referringClass.Alias;
                        referencedClass.ReferringRelationshipName = relationship.Name;
                        referencedClass.Caption = leafClassCaption;
                        _dataView.ReferencedClasses.Add(referencedClass);
                    ...
                    {
                        MessageBox.Show(MessageResourceManager.GetString("SchemaEditor.ReferenceLeafClassAdded"), "Notify Dialog",
                            MessageBoxButtons.OK,
                            MessageBoxIcon.Information);
                    }
