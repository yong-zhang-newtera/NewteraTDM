...
namespace Newtera.Studio
{
	...
	{		
        ...
        /// </summary>
        /// <param name="schemaInfo">The schema info to be accessed.</param>
        /// <param name="isSafeMode">Indicate whether to update a schema in safe mode</param>
        /// <returns>A connection string</returns>
        public string Create(SchemaInfo schemaInfo, bool isSafeMode)
        {
            StringBuilder builder = new StringBuilder();
            CustomPrincipal principal = Thread.CurrentPrincipal as CustomPrincipal;
            string userName;
        ...
        /// <param name="isSafeMode">Indicate whether to update a schema in safe mode</param>
        /// <returns>A connection string</returns>
        public string Create(SchemaInfoElement schemaInfoElement, bool isSafeMode)
        {
            StringBuilder builder = new StringBuilder();
            CustomPrincipal principal = Thread.CurrentPrincipal as CustomPrincipal;
            string userName;
