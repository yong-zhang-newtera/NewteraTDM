...
{
	/// <summary>
	/// Summary description for DBSetupServerConfig.
	/// </summary>
	public class DBSetupServerConfig : System.Windows.Forms.Form
	{
		...
		private void UpdateServerConfig()
		{
			try
			{
				...
				service.UpdateServerConfig(_wizard.DatabaseType, _wizard.DataSource,
					_wizard.ImageBaseURL, _wizard.ImageBasePath);
			}
			catch (Exception ex)
			{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DBSetupServerConfig));
		...
		private void nextButton_Click(object sender, System.EventArgs e)
		{
			try
			{
				// prevent the next button is clicked multiple times
