	...
	public sealed class TextResourceManager
	{
		...
		private static ResourceManager GetResources() 
		{
			...
			if (resources == null)
			{
				...
				try
				{
                    resources = new ResourceManager("Newtera.WorkflowMonitor.TextResourceManager",
                        typeof(Newtera.WorkflowMonitor.TextResourceManager).Assembly);
