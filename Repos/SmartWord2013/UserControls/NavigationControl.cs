...
namespace SmartWord2013
{
    public partial class NavigationControl : UserControl
    {
        ...
        private void ExecuteQuery()
        {
            try
            {
                ...
                if (this.resultDataControl.CurrentSlide.DataView != null)
                {
                    ...
                    // invoke the web service synchronously
                    XmlNode xmlNode = service.ExecuteQuery(ConnectionStringBuilder.Instance.Create(_metaData.SchemaInfo),
                        query);
        ...
        private void ExecuteQueryCount()
        {
            try
            {
                ...
                if (this.resultDataControl.CurrentSlide.DataView != null)
                {
                    ...
                    int count = service.ExecuteCount(ConnectionStringBuilder.Instance.Create(_metaData.SchemaInfo),
                        query);
        ...
        private void setupServerURLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                MessageBox.Show(Newtera.WindowsControl.MessageResourceManager.GetString("SmartWord.CorrectURL"),
        ...
        private void GetAllInstances()
        {
            ...
            try
            {
                ...
                if (this.resultDataControl.CurrentSlide.DataView != null)
                {
                    ...
                    queryId = service.BeginQuery(ConnectionStringBuilder.Instance.Create(_metaData.SchemaInfo),
                        query,
                        _pageSize);
                    ...
                    while (instanceCount < this.resultDataControl.CurrentSlide.TotalInstanceCount && !_isCancelled)
                    {
                        ...
                        xmlNode = service.GetNextResult(ConnectionStringBuilder.Instance.Create(_metaData.SchemaInfo),
                            queryId);
                    ...
                    this.resultDataControl.ShowQueryResult(masterDataSet);
