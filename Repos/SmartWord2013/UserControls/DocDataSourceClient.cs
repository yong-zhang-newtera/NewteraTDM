    ...
    public class DocDataSourceClient : DocDataSourceBase
    {
        ...
        public override InstanceView GetInstanceView(Word.XMLNode familyNode, Word.XMLNode viewNode)
        {
            ...
            if (instanceDataView != null)
            {
                ...
                int totalCount = service.ExecuteCount(ConnectionStringBuilder.Instance.Create(MetaData.SchemaInfo),
                    query);
                ...
                string queryId = service.BeginQuery(ConnectionStringBuilder.Instance.Create(MetaData.SchemaInfo), query, _pageSize);
                ...
                while (instanceCount < totalCount)
                {
                    ...
                    xmlNode = service.GetNextResult(ConnectionStringBuilder.Instance.Create(MetaData.SchemaInfo),
                        queryId);
