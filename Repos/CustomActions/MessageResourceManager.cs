...
namespace Newtera.CustomActions
{
	...
	/// <summary> 
	/// A utility class that cache the resources for messages used in
    /// Newtera.CustomActions namespace.
	/// </summary>
	/// <version> 1.0.0 23 Jul 2007 </version>
	internal sealed class MessageResourceManager
	{
		...
		private static ResourceManager GetResources() 
		{
			...
			if (resources == null)
			{
				...
				try
				{
                    resources = new ResourceManager("Newtera.CustomActions.MessageResourceManager",
                        typeof(Newtera.CustomActions.MessageResourceManager).Assembly);
