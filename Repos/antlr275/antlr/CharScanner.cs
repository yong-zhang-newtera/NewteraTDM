	...
	public abstract class CharScanner : TokenStream, ICharScannerDebugSubject
	{
		...
		*/
		...
		protected internal virtual IToken makeToken(int t)
		{
			...
			try
			{
				...
				if (newToken != null)
				{
					...
					newToken.setPosition(inputState.tokenStartPostion); // modified by Yong Zhang
					//inputState.input.
		...
		public virtual void  newline()
		{
			inputState.line++;
			inputState.column = 1;
			// decrese two position for a new line
			inputState.position --;
		}
		...
		*/
		...
		public virtual void  resetText()
		{
			...
			inputState.tokenStartPostion = inputState.position;
		}
