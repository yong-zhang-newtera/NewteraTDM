...
namespace Newtera.MLActivities.NeuralNetworkConfig
{
    ...
    public class TestCommand : NativeActivity, IMLActivity
    {
        ...
        protected override void CacheMetadata(NativeActivityMetadata metadata)
        {
            ...
            {
                metadata.AddValidationError("TestCommand activity can only be child activity of CustomConfiguration activity");
            }
        }
