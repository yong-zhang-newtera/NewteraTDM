...
namespace Newtera.MLActivities.NeuralNetworkConfig
{
    ...
    public class TrainCommand : NativeActivity, IMLActivity
    {
        ...
        protected override void CacheMetadata(NativeActivityMetadata metadata)
        {
            ...
            {
                metadata.AddValidationError("TrainCommand activity can only be child activity of CustomConfiguration activity");
            }
        }
