...
{
    [ActivityValidator(typeof(CloseGroupTaskValidator))]
    [DefaultProperty("ActivityName")]
    public partial class CloseGroupTaskActivity : System.Workflow.ComponentModel.Activity, ICustomTypeDescriptor
    {
        [NonSerialized]
        ...
        public static DependencyProperty ActivityNameProperty = DependencyProperty.Register("ActivityName", typeof(string), typeof(CloseGroupTaskActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        public static DependencyProperty WriteLogProperty = DependencyProperty.Register("WriteLog", typeof(bool), typeof(CloseGroupTaskActivity), new PropertyMetadata(false, DependencyPropertyOptions.Metadata));
        ...
        [DescriptionAttribute("The ActivityName property is used to specify the name of the CreateGroupTaskActivity that created the task.")]
        ...
        public string ActivityName
        {
            get
            {
                return ((string)(base.GetValue(CloseGroupTaskActivity.ActivityNameProperty)));
            }
            set
            {
                base.SetValue(CloseGroupTaskActivity.ActivityNameProperty, value);
            }
        }
        ...
        public bool WriteLog
        {
            get
            {
                return ((bool)(base.GetValue(CloseGroupTaskActivity.WriteLogProperty)));
            }
            set
            {
                base.SetValue(CloseGroupTaskActivity.WriteLogProperty, value);
            }
        }
        ...
        private void CloseTasks(ActivityExecutionContext context)
        {
        ...
        #region CloseGroupTaskValidator

        public class CloseGroupTaskValidator : System.Workflow.ComponentModel.Compiler.ActivityValidator
        {
            ...
            public override ValidationErrorCollection ValidateProperties(ValidationManager manager,object obj)
            {
                ...
                CloseGroupTaskActivity activity = obj as CloseGroupTaskActivity;
                if (activity != null)
                {
                    // Validate the ActivityName property
                    if (String.IsNullOrEmpty(activity.ActivityName))
                    {
                        validationErrors.Add(ValidationError.GetNotSetValidationError(CloseGroupTaskActivity.ActivityNameProperty.Name));
            ...
            private bool IsValidActivityName(CloseGroupTaskActivity activity)
            {
