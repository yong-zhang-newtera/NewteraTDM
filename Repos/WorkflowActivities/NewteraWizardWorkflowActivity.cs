...
{
    [ActivityValidator(typeof(NewteraWizardWorkflowValidator))]
    [DefaultProperty("SchemaId")]
    public partial class NewteraWizardWorkflowActivity : StateMachineWorkflowActivity, INewteraWorkflow, ICustomTypeDescriptor
    {
        #region public event
        ...
        public static DependencyProperty SchemaIdProperty =
            DependencyProperty.Register("SchemaId", typeof(string), typeof(NewteraWizardWorkflowActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        public static DependencyProperty ClassNameProperty =
            DependencyProperty.Register("ClassName", typeof(string), typeof(NewteraWizardWorkflowActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        public static DependencyProperty ClassCaptionProperty =
            DependencyProperty.Register("ClassCaption", typeof(string), typeof(NewteraWizardWorkflowActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        public static DependencyProperty EventNameProperty =
            DependencyProperty.Register("EventName", typeof(string), typeof(NewteraWizardWorkflowActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        public static DependencyProperty InputParametersProperty =
            DependencyProperty.Register("InputParameters", typeof(IList), typeof(NewteraWizardWorkflowActivity)); // run-time update

        #endregion

        public NewteraWizardWorkflowActivity() : base("Wizard Workflow")
        {
        }
        ...
        public string SchemaId
        {
            get
            {
                return ((string)(base.GetValue(NewteraWizardWorkflowActivity.SchemaIdProperty)));
            }
            set
            {
                base.SetValue(NewteraWizardWorkflowActivity.SchemaIdProperty, value);
            }
        }
        ...
        public string ClassName
        {
            get
            {
                return ((string)(base.GetValue(NewteraWizardWorkflowActivity.ClassNameProperty)));
            }
            set
            {
                base.SetValue(NewteraWizardWorkflowActivity.ClassNameProperty, value);
            }
        }
        ...
        public string ClassCaption
        {
            get
            {
                return ((string)(base.GetValue(NewteraWizardWorkflowActivity.ClassCaptionProperty)));
            }
            set
            {
                base.SetValue(NewteraWizardWorkflowActivity.ClassCaptionProperty, value);
            }
        }
        ...
        public IInstanceWrapper Instance
        {
            get
            {
                if (!this.DesignMode)
                {
                    ...
                    {
                        //ErrorLog.Instance.WriteLine("NewteraWizardWorkflowActivity.Instance failed:" + ex.Message);
        ...
        public string EventName
        {
            get
            {
                return ((string)(base.GetValue(NewteraWizardWorkflowActivity.EventNameProperty)));
            }
            set
            {
                string oldVal = ((string)(base.GetValue(NewteraWizardWorkflowActivity.EventNameProperty)));
                base.SetValue(NewteraWizardWorkflowActivity.EventNameProperty, value);
        ...
        public IList InputParameters
        {
            get
            {
                return ((IList)(base.GetValue(NewteraWizardWorkflowActivity.InputParametersProperty)));
            }
            set
            {
                base.SetValue(NewteraWizardWorkflowActivity.InputParametersProperty, value);
            }
        }
        ...
        /// <summary>
        /// Custom validator for NewteraWizardWorkflowActivity
        /// </summary>
        public class NewteraWizardWorkflowValidator : System.Workflow.ComponentModel.Compiler.CompositeActivityValidator
        {
            ...
            public override ValidationErrorCollection ValidateProperties(ValidationManager manager, object obj)
            {
                ...
                NewteraWizardWorkflowActivity activity = obj as NewteraWizardWorkflowActivity;
            ...
            private void ValidateProperties(ValidationErrorCollection validationErrors, NewteraWizardWorkflowActivity activity)
            {
