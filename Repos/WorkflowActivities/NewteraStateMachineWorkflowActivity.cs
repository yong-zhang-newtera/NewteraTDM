...
{
    [ActivityValidator(typeof(NewteraStateMachineWorkflowValidator))]
    [DefaultProperty("SchemaId")]
    public partial class NewteraStateMachineWorkflowActivity : StateMachineWorkflowActivity, INewteraWorkflow, ICustomTypeDescriptor
    {
        #region public event
        ...
        public static DependencyProperty SchemaIdProperty =
            DependencyProperty.Register("SchemaId", typeof(string), typeof(NewteraStateMachineWorkflowActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        public static DependencyProperty ClassNameProperty =
            DependencyProperty.Register("ClassName", typeof(string), typeof(NewteraStateMachineWorkflowActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        public static DependencyProperty ClassCaptionProperty =
            DependencyProperty.Register("ClassCaption", typeof(string), typeof(NewteraStateMachineWorkflowActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        public static DependencyProperty EventNameProperty =
            DependencyProperty.Register("EventName", typeof(string), typeof(NewteraStateMachineWorkflowActivity), new PropertyMetadata(DependencyPropertyOptions.Metadata));
        public static DependencyProperty InputParametersProperty =
            DependencyProperty.Register("InputParameters", typeof(IList), typeof(NewteraStateMachineWorkflowActivity)); // run-time update

        #endregion

        public NewteraStateMachineWorkflowActivity()
        {
        }
        ...
        public string SchemaId
        {
            get
            {
                return ((string)(base.GetValue(NewteraStateMachineWorkflowActivity.SchemaIdProperty)));
            }
            set
            {
                base.SetValue(NewteraStateMachineWorkflowActivity.SchemaIdProperty, value);
            }
        }
        ...
        public string ClassName
        {
            get
            {
                return ((string)(base.GetValue(NewteraStateMachineWorkflowActivity.ClassNameProperty)));
            }
            set
            {
                base.SetValue(NewteraStateMachineWorkflowActivity.ClassNameProperty, value);
            }
        }
        ...
        public string ClassCaption
        {
            get
            {
                return ((string)(base.GetValue(NewteraStateMachineWorkflowActivity.ClassCaptionProperty)));
            }
            set
            {
                base.SetValue(NewteraStateMachineWorkflowActivity.ClassCaptionProperty, value);
            }
        }
        ...
        public string EventName
        {
            get
            {
                return ((string)(base.GetValue(NewteraStateMachineWorkflowActivity.EventNameProperty)));
            }
            set
            {
                string oldVal = ((string)(base.GetValue(NewteraStateMachineWorkflowActivity.EventNameProperty)));
                base.SetValue(NewteraStateMachineWorkflowActivity.EventNameProperty, value);
        ...
        public IList InputParameters
        {
            get
            {
                return ((IList)(base.GetValue(NewteraStateMachineWorkflowActivity.InputParametersProperty)));
            }
            set
            {
                base.SetValue(NewteraStateMachineWorkflowActivity.InputParametersProperty, value);
            }
        }
        ...
        /// <summary>
        /// Custom validator for NewteraStateMachineWorkflowActivity
        /// </summary>
        public class NewteraStateMachineWorkflowValidator : System.Workflow.ComponentModel.Compiler.CompositeActivityValidator
        {
            ...
            public override ValidationErrorCollection ValidateProperties(ValidationManager manager, object obj)
            {
                ...
                NewteraStateMachineWorkflowActivity activity = obj as NewteraStateMachineWorkflowActivity;
            ...
            private void ValidateProperties(ValidationErrorCollection validationErrors, NewteraStateMachineWorkflowActivity activity)
            {
