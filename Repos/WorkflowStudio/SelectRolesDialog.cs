...
namespace WorkflowStudio
{
	...
	public class SelectRolesDialog : System.Windows.Forms.Form
	{
        ...
        /// <summary>
        /// Gets or sets the information indicating whether relationship among the selected roles are AND or OR. Default is AND
        /// </summary>
        public bool IsLogicalAnd
        {
            get
            {
                return _isLogicalAnd;
            }
            set
            {
                _isLogicalAnd = value;
		...
		private void InitializeComponent()
		{
            ...
            // allRolesListBox
            // 
            this.allRolesListBox.AccessibleDescription = null;
            this.allRolesListBox.AccessibleName = null;
            resources.ApplyResources(this.allRolesListBox, "allRolesListBox");
            this.allRolesListBox.BackgroundImage = null;
            this.allRolesListBox.Font = null;
            ...
            // 
            this.selectedRolesListBox.AccessibleDescription = null;
            this.selectedRolesListBox.AccessibleName = null;
            resources.ApplyResources(this.selectedRolesListBox, "selectedRolesListBox");
            this.selectedRolesListBox.BackgroundImage = null;
            this.selectedRolesListBox.Font = null;
		...
		private void SelectRolesDialog_Load(object sender, System.EventArgs e)
		{
            ...
            if (!_isLogicalAnd)
            {
                // display the logical OR related text
                this.label2.Text = MessageResourceManager.GetString("WorkflowStudioApp.LogicalORRoles");
            }
