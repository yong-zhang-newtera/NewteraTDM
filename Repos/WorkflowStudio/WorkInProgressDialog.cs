	...
	public class WorkInProgressDialog : System.Windows.Forms.Form
	{
		...
		public string DisplayText
		{
			...
			set
			{
				if (value == null)
				{
					_displayText = this._defaultMessage;
				}
				else
				{
                    _displayText = value;
		...
		{
            // change the display text if available
            if (this.label1.Text != _displayText)
            {
                this.label1.Text = _displayText;
            }
