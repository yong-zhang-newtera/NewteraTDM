	...
	public class RegisterClientDialog : System.Windows.Forms.Form
	{
		...
		private void RegisterButton_Click(object sender, System.EventArgs e)
		{
				...
				this.clientIDTextBox.Text.Length > 0)
			{
				...
				try
				{
					...
					service.RegisterClient(NewteraNameSpace.WORKFLOW_STUDIO_NAME,
                        this.clientIDTextBox.Text, machineName);

                    MessageBox.Show(MessageResourceManager.GetString("WorkflowStudio.ClientAdded"),
                                    "Info",
		...
		private void removeButton_Click(object sender, System.EventArgs e)
		{
			if (registeredClientsListBox.SelectedIndex >= 0)
			{
				...
				try
				{
					...
					service.UnregisterClient(NewteraNameSpace.WORKFLOW_STUDIO_NAME,
						clientId);

                    MessageBox.Show(MessageResourceManager.GetString("WorkflowStudio.ClientRemoved"),
                                    "Info",
                                    MessageBoxButtons.OK,
                                    MessageBoxIcon.Information);
				}
		...
		private void ShowRegisteredClients()
		{
			...
			try
			{
				...
				string[] clientIds = service.GetRegisteredClients(NewteraNameSpace.WORKFLOW_STUDIO_NAME);
