...
namespace DisableLicense.AdminWebService {
    using System;
    ...
    public partial class AdminService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public AdminService() {
            this.Url = global::DisableLicense.Properties.Settings.Default.DisableLicense_AdminWebService_AdminService;
        ...
        public void RegisterClient(string clientName, string clientId) {
        ...
        /// <remarks/>
        public void RegisterClientAsync(string clientName, string clientId) {
            this.RegisterClientAsync(clientName, clientId, null);
        }
        
        /// <remarks/>
        public void RegisterClientAsync(string clientName, string clientId, object userState) {
            ...
            this.InvokeAsync("RegisterClient", new object[] {
                        clientName,
                        clientId}, this.RegisterClientOperationCompleted, userState);
        }
