...
using SmartExcel.AttachmentWebService;
using SmartExcel.CMDataWebService;
using SmartExcel.MetaDataWebService;
using SmartExcel.UserInfoWebService;
using SmartExcel.WorkflowModelWebService;
using SmartExcel.OLAPWebService;
	...
	{		
		...
		private bool NeedUpdateConfig
		{
			get
			{
                ...
                string serverUrl = SmartExcel.Properties.Settings.Default.SmartExcel_AdminWebService_AdminService;
		...
		{
            SmartExcel.Properties.Settings settings = SmartExcel.Properties.Settings.Default;
            string baseUrl = this.serverURLTextBox.Text.Trim();

            settings.SmartExcel_AdminWebService_AdminService = GetNewUrl(settings.SmartExcel_AdminWebService_AdminService,
                baseUrl);

            settings.SmartExcel_AttachmentWebService_AttachmentService = GetNewUrl(settings.SmartExcel_AttachmentWebService_AttachmentService,
                baseUrl);

            settings.SmartExcel_CMDataWebService_CMDataService = GetNewUrl(settings.SmartExcel_CMDataWebService_CMDataService,
                baseUrl);

            settings.SmartExcel_MetaDataWebService_MetaDataService = GetNewUrl(settings.SmartExcel_MetaDataWebService_MetaDataService,
                baseUrl);

            settings.SmartExcel_UserInfoWebService_UserInfoService = GetNewUrl(settings.SmartExcel_UserInfoWebService_UserInfoService,
                baseUrl);

            settings.SmartExcel_WorkflowModelWebService_WorkflowModelService = GetNewUrl(settings.SmartExcel_WorkflowModelWebService_WorkflowModelService,
                baseUrl);

            settings.SmartExcel_OLAPWebService_OLAPService = GetNewUrl(settings.SmartExcel_OLAPWebService_OLAPService,
              baseUrl);
