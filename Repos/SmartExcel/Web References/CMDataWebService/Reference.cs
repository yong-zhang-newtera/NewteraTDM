...
namespace SmartExcel.CMDataWebService {
    ...
    public partial class CMDataService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GenerateXmlDocOperationCompleted;
        ...
        public CMDataService() {
            this.Url = global::SmartExcel.Properties.Settings.Default.SmartExcel_CMDataWebService_CMDataService;
        ...
        /// <remarks/>
        public event GenerateXmlDocCompletedEventHandler GenerateXmlDocCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.newtera.com/webservices/GenerateXmlDoc", RequestNamespace="http://www.newtera.com/webservices/", ResponseNamespace="http://www.newtera.com/webservices/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public System.Xml.XmlNode GenerateXmlDoc(string connectionStr, string xmlSchemaName, string query, string baseClassName) {
            object[] results = this.Invoke("GenerateXmlDoc", new object[] {
                        connectionStr,
                        xmlSchemaName,
                        query,
                        baseClassName});
        ...
        /// <remarks/>
        public void GenerateXmlDocAsync(string connectionStr, string xmlSchemaName, string query, string baseClassName) {
            this.GenerateXmlDocAsync(connectionStr, xmlSchemaName, query, baseClassName, null);
        }
        
        /// <remarks/>
        public void GenerateXmlDocAsync(string connectionStr, string xmlSchemaName, string query, string baseClassName, object userState) {
            if ((this.GenerateXmlDocOperationCompleted == null)) {
                this.GenerateXmlDocOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGenerateXmlDocOperationCompleted);
            }
            this.InvokeAsync("GenerateXmlDoc", new object[] {
                        connectionStr,
                        xmlSchemaName,
                        query,
                        baseClassName}, this.GenerateXmlDocOperationCompleted, userState);
        }
        
        private void OnGenerateXmlDocOperationCompleted(object arg) {
            if ((this.GenerateXmlDocCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GenerateXmlDocCompleted(this, new GenerateXmlDocCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.3053")]
    public delegate void GenerateXmlDocCompletedEventHandler(object sender, GenerateXmlDocCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.3053")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GenerateXmlDocCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GenerateXmlDocCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
