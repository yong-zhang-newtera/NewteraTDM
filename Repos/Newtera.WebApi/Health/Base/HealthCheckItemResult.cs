...
namespace Newtera.WebApi.Health
{
    ...
    public class HealthCheckItemResult
    {
        ...
        public HealthCheckItemResult(string resourceName, int sortOrder, string friendlyName, string description = null, string resourceType = null)
        {
        ...
        /// </summary>
        [JsonProperty(Order = -60)] // Push them to the top of the list, with the base properties coming first.
        public string FriendlyName { get; }

        /// <summary>
        /// Gets or sets the description of the health check .
        /// </summary>
        [JsonProperty(Order = -50)] // Push them to the top of the list, with the base properties coming first. 
        public string Description { get; set; }

        /// <summary>
        /// Gets a value that indicates if the type of the current resource.
        /// </summary>
