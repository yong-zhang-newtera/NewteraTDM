...
namespace Newtera.WebApi.Infrastructure
{
	...
	/// <summary>
	/// The WebApiNameSpace class is a centralized place where keywords belong to 
	/// Newtera Web API package are defined as constants. Application will refer to the 
