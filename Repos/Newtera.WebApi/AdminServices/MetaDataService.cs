    ...
    public class MetaDataServiceController : ApiController
    {
        ...
        public HttpResponseMessage GetImageNames()
        {
            try
            {
                ...
                List<ImageModel> images = imageManager.GetImageModels(NewteraNameSpace.USER_ICON_DIR);
        ...
        public HttpResponseMessage GetImageBytes(string imageName)
        {
            try
            {
                ...
                string imagePath = staticFilesDir + NewteraNameSpace.USER_ICON_DIR + @"\" + imageName;
