...
angular.module('app.wizards').controller('itemTreeModalCtrl', function ($rootScope, $scope, $http, APP_CONFIG, $stateParams, $state, RequestInfo, MetaDataCache, $modalInstance) {
    ...
    if (MetaDataCache.getNamedData(itemTemplateClass + "tree")) {
        $scope.itemTree = MetaDataCache.getNamedData(itemTemplateClass + "tree");
        $scope.itemCategories = MetaDataCache.getNamedData(itemTemplateClass + "categories");
    }
    else {
        ...
        $http.get(url).then(function (res) {
            ...
            MetaDataCache.setNamedData(itemTemplateClass + "tree", $scope.itemTree);
        });
    }
    ...
    function CreateTree(res, groupName, categoryName, categoryForm, bottomClass) {
        ...
        MetaDataCache.setNamedData(itemTemplateClass + "categories", categories);
