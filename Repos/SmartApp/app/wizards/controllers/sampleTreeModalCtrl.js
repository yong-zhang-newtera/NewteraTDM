...
angular.module('app.wizards').controller('sampleTreeModalCtrl', function ($rootScope, $scope, $http, APP_CONFIG, $stateParams, $state, RequestInfo, MetaDataCache, $modalInstance) {
    ...
    if (MetaDataCache.getNamedData(sampleCategoryClass + "tree")) {
        $scope.sampleTree = MetaDataCache.getNamedData(sampleCategoryClass + "tree");
        $scope.sampleCategories = MetaDataCache.getNamedData(sampleCategoryClass + "categories");
    }
    else {
        ...
        $http.get(url).then(function (res) {
            ...
            MetaDataCache.setNamedData(sampleCategoryClass + "tree", $scope.sampleTree);
        });
    }
    ...
    function CreateTree(res, groupName, categoryName, categoryForm, bottomClass) {
        ...
        MetaDataCache.setNamedData(sampleCategoryClass + "categories", categories);
