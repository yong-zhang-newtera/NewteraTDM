	...
	{		
        ...
        public List<ImageInfo> GetAllImageInfos()
        {
            if (_imageInfos == null)
            {
                ...
                MetaDataServiceStub imageService = new MetaDataServiceStub();
                try
                {
                    string[] imageNames = imageService.GetImageNames();
                    ImageInfo imageInfo;
                    MemoryStream ms;
                    foreach (string imageName in imageNames)
                    {
                        ...
                        try
                        {
                            byte[] imageData = imageService.GetImageBytes(imageName);
