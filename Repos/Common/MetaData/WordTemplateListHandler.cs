...
namespace Newtera.Common.MetaData
{
	...
	/// <summary>
	/// Represents an handler that retrieve a list of word templates for a class.
	/// </summary>
	/// <version> 1.0.0 25 May 2012 </version>
	public class WordTemplateListHandler : IListHandler
	{
		/// <summary>
        /// Get a list of word templates for a class.
		/// </summary>
                ...
                if (context != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(parameter))
                    {
                        ...
                        if (current is MetaDataModel)
                        {
                            ...
                            string[] files = serverProxy.GetReportTemplatesFileNames(schemaId, parameter);
