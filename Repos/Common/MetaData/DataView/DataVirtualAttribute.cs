...
namespace Newtera.Common.MetaData.DataView
{
	...
	/// <summary>
	/// A DataVirtualAttribute instance represents a virtual attribute in a data view.
	/// It can appears in the result attribute collection.
	/// </summary>
	/// <version>1.0.1 27 May 2007</version>
	public class DataVirtualAttribute : DataViewElementBase, IQueryElement
	{
		private string _ownerClassAlias;
		private string _value;

		/// <summary>
		/// Initiating an instance of DataVirtualAttribute class
		/// </summary>
		...
		public DataVirtualAttribute(string name, string ownerClassAlias) : base(name)
		{
		...
		internal DataVirtualAttribute(XmlElement xmlElement) : base()
		{
		...
		public override ElementType ElementType 
		{
			get
			{
				return ElementType.VirtualAttribute;
			}
		}
		...
		public override SchemaModelElement GetSchemaModelElement()
		{
			if (_schemaModelElement == null && DataView != null)
			{
                ...
                if (ownerClass != null)
                {
                    ...
                    _schemaModelElement = classElement.FindInheritedVirtualAttribute(Name);
                }
			}
