/*
* @(#)PropagateFunctionParametersVisitor.cs
*
...
namespace Newtera.Common.MetaData.DataView
{
	...
	/// <summary>
	/// Represents a visitor that propagate parameters to the functions contained in a xquery. 
	/// </summary>
	/// <version> 1.0.0 04 May 2008 </version>
	public class PropagateFunctionParametersVisitor : IDataViewElementVisitor
	{
		...
		/// <summary>
		/// Set a data instance id to the functions
		/// </summary>
		/// <param name="objId">The data instance id.</param>
		public PropagateFunctionParametersVisitor(string schemaName, string schemaVersion,
            string className, string objId)
		{
        ...
        {
            element.SchemaName = _schemaName;
            element.SchemaVersion = _schemaVersion;
            element.ClassName = _className;
            element.ObjId = _objId;
            return true;
        }
