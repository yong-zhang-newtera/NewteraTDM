/*
* @(#)ArrayDataRowPropertyDescriptor.cs
*
...
namespace Newtera.Common.MetaData.DataView
{
	...
	public class ArrayDataRowPropertyDescriptor : PropertyDescriptor
	{
		...
		/// </summary>
		public ArrayDataRowPropertyDescriptor(string name, Attribute[] attributes,
			DataTable dataTable, int rowIndex) : base(name, attributes)
		{
		...
		public override TypeConverter Converter
		{
			get
			{
				return new ArrayDataRowViewConverter();
			}
		}
		...
		public override string DisplayName
		{
			get
			{
				// get the sequence number at the end of property name
		...
		{
			return new ArrayDataRowView(this.Name, _dataTable, _rowIndex);
		}
