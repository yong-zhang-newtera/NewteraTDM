...
namespace Newtera.Common.MetaData.Subscribers
{
	...
	/// <summary> 
	/// The base class for all node in Subscribers package
	/// </summary>
	/// <version> 1.0.0 16 Sept 2013</version>
    public abstract class SubscriberNodeBase : ISubscriberNode, ICustomTypeDescriptor
	{
		...
		/// <summary>
		/// Initiate an instance of SubscriberNodeBase class
		/// </summary>
		public SubscriberNodeBase()
		{
            _name = null;
		}
        ...
        /// Initiate an instance of SubscriberNodeBase class
        /// </summary>
        public SubscriberNodeBase(string name)
        {
            _name = name;
        }

		#region ISubscriberNode interface implementation
		...
		public abstract SubscriberNodeType NodeType {get;}
        ...
        public abstract void Accept(ISubscriberNodeVisitor visitor);
		...
		protected void FireValueChangedEvent(object value)
		{
			if (ValueChanged != null)
			{
				ValueChanged(this, new ValueChangedEventArgs("ISubscriberNode", value));
			}
		}
