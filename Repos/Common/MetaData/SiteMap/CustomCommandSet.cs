...
namespace Newtera.Common.MetaData.SiteMap
{
	...
	/// <summary>
	/// Represents a custom command set object
	/// </summary>
	/// <version> 1.0.0 27 Nov 2010 </version>
	public class CustomCommandSet : ISiteMapNode
	{
        private ISiteMapNode _parent;
        private SiteMapNodeCollection _groups = new SiteMapNodeCollection();
        private Hashtable _customCommandGroupTable = null;
		...
		/// <summary>
		///  Initializes a new instance of the CustomCommandSet class.
		/// </summary>
		public CustomCommandSet() : base()
		{
		}

		/// <summary>
		/// Initiating an instance of CustomCommandSet class
		/// </summary>
		/// <param name="xmlElement">The xml element conatins data of the instance</param>
		internal CustomCommandSet(XmlElement xmlElement) : base()
		{
			this.Unmarshal(xmlElement);
		}

        /// <summary>
        /// Gets a Custom Command Group given a schema id and class name
        /// </summary>
        ...
        {
            CustomCommandGroup found = null;

            if (_customCommandGroupTable == null)
            {
                _customCommandGroupTable = new Hashtable();

                foreach (CustomCommandGroup customCommandGroup in this.ChildNodes)
                {
                    _customCommandGroupTable[customCommandGroup.Database + customCommandGroup.ClassName] = customCommandGroup;
                }
            }

            found = (CustomCommandGroup)_customCommandGroupTable[schemaId + className];
		...
		public void Write(Stream stream)
		{
			...
			{
				throw new SiteMapException("Failed to write the CustomCommandSet object", ex);
			}
		}
		...
		public NodeType NodeType	{
			get
			{
				return NodeType.CustomCommandSet;
			}
		}
        ...
        {
            if (visitor.VisitCustomCommandSet(this))
            {
        ...
        public virtual string ToDisplayPath()
        {
            if (ParentNode != null)
            {
                return ParentNode.ToDisplayPath() + "/CustomCommandSet";
            }
            else
            {
                return "/Model/CustomCommandSet";
            }
        }
        ...
        public virtual string ToXPath()
        {
            if (ParentNode != null)
            {
                return ParentNode.ToXPath() + "/CustomCommandSet";
            }
            else
            {
                return "/Model/CustomCommandSet";
