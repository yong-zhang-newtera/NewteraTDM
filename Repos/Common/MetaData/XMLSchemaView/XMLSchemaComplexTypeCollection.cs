/*
* @(#)XMLSchemaComplexTypeCollection.cs
*
...
namespace Newtera.Common.MetaData.XMLSchemaView
{
	...
	/// <summary>
	/// Represents a collection of XMLSchemaComplextType objects.
	/// </summary>
    /// <version>  	1.0.0 10 Aug 2014</version>
	public class XMLSchemaComplexTypeCollection : XMLSchemaNodeCollection
	{
		private bool _isAltered;
        private IXMLSchemaNode _parentNode;

		/// <summary>
		/// Initiating an instance of XMLSchemaComplexTypeCollection class
		/// </summary>
		public XMLSchemaComplexTypeCollection() : base()
		{
			_isAltered = false;
			_xpath = null;
            _parentNode = null;
        ...
        internal XMLSchemaComplexTypeCollection(XmlElement xmlElement)
            : base()
        {
        ...
        public override XMLSchemaNodeType NodeType 
		{
			get
			{
                return XMLSchemaNodeType.XMLSchemaComplexTypes;
			}
		}
        ...
        /// </summary>
        public override IXMLSchemaNode this[string caption]
        {
            get
            {
        ...
        /// <summary>
		/// Adds a XMLSchemaComplexType to the XMLSchemaComplexTypeCollection.
		/// </summary>
		/// <param name="value">the XMLSchemaComplexType to be added</param>
		/// <returns>The position into which the new element was added</returns>
        public override int Add(IXMLSchemaNode value)
        {
            int pos = 0;
            if (value is XMLSchemaComplexType)
            {
                pos = base.Add(value);
                ((XMLSchemaComplexType)value).ParentNode = this;
            }
            else
            {
                throw new ArgumentException("value must be of type XMLSchemaComplexType.", "value");
            }
        ...
        /// <summary>
		/// inserts a XMLSchemaComplexType to the collection at the specified position
		/// </summary>
		/// <param name="index">The zero-based index at which value should be inserted</param>
		/// <param name="value">The XMLSchemaComplexType to insert into collection</param>
        ...
        /// <summary>
        /// removes the first occurrence of a specific complex type from the collection
        /// </summary>
        /// <param name="value">The name of the complex type.</param>
        public void Remove(string name)
        {
            object value = null;
            foreach (XMLSchemaComplexType complexType in List)
            {
		...
		public override void Unmarshal(XmlElement parent)
		{
			...
			{
				XMLSchemaComplexType xmlSchemaView = (XMLSchemaComplexType) XMLSchemaNodeFactory.Instance.Create(xmlElement);
		...
		public override string ToXPath()
		{
			...
			{
				_xpath = this.Parent.ToXPath() + "/types";
			}
