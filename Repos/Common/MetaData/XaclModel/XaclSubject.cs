...
namespace Newtera.Common.MetaData.XaclModel
{
	...
	public class XaclSubject : XaclNodeBase
	{	
		...
		internal XaclSubject(XmlElement xmlElement) : base()
		{
		...
		{
			bool isEqual = true;
			XaclSubject another = (XaclSubject) obj;
