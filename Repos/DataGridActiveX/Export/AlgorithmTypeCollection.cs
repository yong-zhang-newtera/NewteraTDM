...
namespace Newtera.DataGridActiveX.Export
{
	...
	/// <summary>
	/// An object collection class to handle AlgorithmType when collections are
	/// returned from method calls.
	/// </summary>
	/// <version> 1.0.1 14 Apr 2006 </version>
	/// <author> Yong Zhang</author>
	public class AlgorithmTypeCollection : CollectionBase
	{
		/// <summary>
		///  Initializes a new instance of the AlgorithmTypeCollection class.
		/// </summary>
		public AlgorithmTypeCollection() : base()
		{
		}
		...
		/// </summary>
		public AlgorithmType this[int index]  
		{
			get  
			{
				return((AlgorithmType) List[index] );
			}
			set  
			{
				List[index] = value;
		...
		/// </summary>
		public AlgorithmType this[string name]  
		{
			get  
			{
				AlgorithmType found = null;

				foreach (AlgorithmType element in List)
				{
		...
		/// <summary>
		/// Adds an AlgorithmType to the AlgorithmTypeCollection.
		/// </summary>
		/// <param name="value">the object to be added</param>
		/// <returns>The position into which the new element was inserted</returns>
		public int Add(AlgorithmType value )  
		{
		...
		public int IndexOf(AlgorithmType value )  
		{
		...
		public void Insert(int index, AlgorithmType value)  
		{
		...
		public void Remove(AlgorithmType value )  
		{
			List.Remove(value);
		}
		...
		public bool Contains(AlgorithmType value )  
		{
			// If value is not of type AlgorithmType, this will return false.
		...
		public void Unmarshal(XmlElement parent)
		{
			...
			{
				node = new AlgorithmType();
				node.Unmarshal(xmlElement);

				this.Add((AlgorithmType) node);
			}
		}
		...
		public void Marshal(XmlElement parent)
		{
			...
			foreach (AlgorithmType node in List)
			{
				child = parent.OwnerDocument.CreateElement("AlgorithmType");
				node.Marshal(child);
		...
		{
			if (!(value is AlgorithmType))
			{
				throw new ArgumentException( "value must be of type AlgorithmType.", "value" );
			}
		}
		...
		{
			if (!(newValue is AlgorithmType))
			{
				throw new ArgumentException( "newValue must be of type AlgorithmType.", "newValue" );
			}
		}
		...
		protected override void OnValidate(Object value)  
		{
			if (!(value is AlgorithmType))
			{
				throw new ArgumentException( "value must be of type AlgorithmType." );
			}
		}
		...
		private XmlDocument GetXmlDocument()
		{
			...
			XmlElement element = doc.CreateElement("AlgorithmTypes");
