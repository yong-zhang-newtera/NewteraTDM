...
namespace Newtera.DataGridActiveX
{
	...
	public class ChooseEnumValuePopup : System.Windows.Forms.Form, IExprPopup
	{
		...
		private StringCollection _enumValues;
		...
		/// <summary>
		/// Gets or sets the enum values of constraint
		/// </summary>
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(ChooseEnumValuePopup));
		...
		private void ChooseEnumValuePopup_Load(object sender, System.EventArgs e)
		{
			...
			if (_enumValues != null)
			{
				foreach (string val in _enumValues)
				{
