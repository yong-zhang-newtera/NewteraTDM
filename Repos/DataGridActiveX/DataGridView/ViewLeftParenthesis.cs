...
namespace Newtera.DataGridActiveX.DataGridView
{
	...
	public class ViewLeftParenthesis : DataGridViewElementBase
	{
		private IDataGridViewElement _parent;

		/// <summary>
		/// Initiating an instance of ViewLeftParenthesis class
		/// </summary>
		public ViewLeftParenthesis() : base()
		{
			_parent = null;
		}
		...
		public override ViewElementType ElementType {
			get
			{
				return ViewElementType.LeftParenthesis;
			}
		}
