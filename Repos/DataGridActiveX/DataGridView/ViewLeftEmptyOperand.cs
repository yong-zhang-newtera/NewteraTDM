...
namespace Newtera.DataGridActiveX.DataGridView
{
	...
	public class ViewLeftEmptyOperand : DataGridViewElementBase
	{
		private ViewBinaryExpr _parent;

		/// <summary>
		/// Initiating an instance of ViewLeftEmptyOperand class
		/// </summary>
		public ViewLeftEmptyOperand() : base()
		{
			_parent = null;
		}
		...
		public override ViewElementType ElementType 
		{
			get
			{
				return ViewElementType.LeftEmptyOperand;
			}
		}
